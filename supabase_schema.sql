...
-- Admin authorization follows the app contract: roles are stored in public.profiles.
-- Supabase Auth JWTs do not include this custom role unless a separate hook is configured.
