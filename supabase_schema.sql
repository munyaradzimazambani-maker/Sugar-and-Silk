...
-- Resolve application roles from the protected profiles table. Supabase's
-- built-in JWT "role" claim is the Postgres role ("authenticated"), not the
-- admin/client role stored by this application.
