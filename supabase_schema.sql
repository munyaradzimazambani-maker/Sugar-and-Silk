...
-- Admin authorization follows the application's profiles.role source of truth.
-- SECURITY DEFINER lets policies check profiles without being blocked by profiles RLS.
