...
-- App authorization stores roles in public.profiles, not in Supabase's built-in
-- JWT role claim. RLS policies call this helper to keep admin checks consistent.
