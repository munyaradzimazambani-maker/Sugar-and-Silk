...
-- Admin checks are based on the application profile role. Supabase auth JWTs do not
-- include public.profiles.role unless custom claims are configured separately.
