...
-- Application admin privileges are stored in public.profiles.role.
-- Supabase's default JWT role claim is the database role (for example, "authenticated"),
-- so RLS must check the same source of truth used by middleware and the UI.
