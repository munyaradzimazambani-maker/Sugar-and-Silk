    ...
    async function handleDocumentUpload(e: ChangeEvent<HTMLInputElement>) {
        ...
        try {
            ...
            if (storageError) {
                ...
                setUploadError('Upload failed before the file could be saved.');
                return;
            }
            ...
            if (dbError) {
                ...
                setUploadError('Upload could not be saved. Please retry.');
                return;
            }
                    ...
                    <motion.div variants={item} className="p-8 rounded-2xl bg-slate-900 border border-slate-800">
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <div className="relative">
                                ...
                                {uploadError && (
                                    <p className="absolute right-0 top-12 w-64 text-xs font-medium text-red-400 text-right">
                                        {uploadError}
                                    </p>
                                )}
                            </div>
