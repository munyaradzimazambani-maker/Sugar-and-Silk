...
export default function AdminClientDetailPage() {
    ...
    async function handleDocumentUpload(file: File) {
        ...
        if (dbError) {
            ...
            setUploadErrorMessage('Upload failed before it could be saved. Please try again.');
            setUploading(false);
            return;
        }
                    ...
                    <motion.div variants={item} className="p-8 rounded-2xl bg-slate-900 border border-slate-800">
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <div className="relative">
                                ...
                                {uploadErrorMessage && (
                                    <p className="absolute right-0 top-full mt-2 w-64 text-xs text-red-400 text-right">
                                        {uploadErrorMessage}
                                    </p>
                                )}
                            </div>
