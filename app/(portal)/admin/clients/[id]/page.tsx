...
export default function AdminClientDetailPage() {
    ...
    async function handleDocumentUpload(file: File) {
        ...
        if (dbError) {
            ...
            setUploadError('Document metadata could not be saved. The uploaded file was rolled back.');
            setUploading(false);
            return;
        }
                    ...
                    <motion.div variants={item} className="p-8 rounded-2xl bg-slate-900 border border-slate-800">
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <div className="relative">
                                ...
                                {uploadError && (
                                    <p className="absolute right-0 mt-2 w-72 text-right text-xs font-medium text-red-400">
                                        {uploadError}
                                    </p>
                                )}
                            </div>
