    ...
    async function handleDocumentUpload(e: React.ChangeEvent<HTMLInputElement>) {
        ...
        try {
            ...
            if (uploadError) {
                ...
                setDocumentUploadError('Upload failed before the file was saved. Please try again.');
                return;
            }
            ...
            if (dbError) {
                ...
                setDocumentUploadError('Upload failed while saving document metadata. The file was not attached; please try again.');
                return;
            }
