                    ...
                    <motion.div variants={item} className="p-8 rounded-2xl bg-slate-900 border border-slate-800">
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    onChange={async (e) => {
                                        ...
                                        if (dbError) {
                                            ...
                                            setUploadError('Upload could not be saved. The file was removed; please try again.');
                                            setUploading(false);
                                            e.target.value = '';
                                            return;
                                        }
                                ...
                                {uploadError && (
                                    <p className="absolute right-0 mt-2 w-64 text-right text-xs font-medium text-red-400">{uploadError}</p>
                                )}
                            </div>
                        </div>
